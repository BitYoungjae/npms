...
run_npm_script() {
  ...
  local life_cycle_ops_json='["preinstall", "install", "postinstall", "preuninstall", "uninstall", "postuninstall", "preversion", "version", "postversion", "pretest", "posttest", "prepublish", "prepare", "prepublishOnly", "postpublish", "prepack", "postpack", "prestop", "poststop", "prestart", "poststart", "prerestart", "restart", "postrestart"]'
